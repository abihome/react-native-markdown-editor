...
const useTextEditor = ({ platformMode, initialMarkdownText = "", }) => {
    const [inputBlockInfoMap, setInputBlockInfoMap] = (0, react_1.useState)(() => (0, utils_1.mardownToInputBlockInfoMap)(initialMarkdownText));
    //eslint-disable-next-line
    const [currentInputBlockKey, setCurrentInputBlockKey] = (0, react_1.useState)("0");
    const [includeSelectionEnd, setIncludeSelectionEnd] = (0, react_1.useState)(true);
