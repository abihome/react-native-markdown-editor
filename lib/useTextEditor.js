...
const useTextEditor = ({ initialMarkdownText = '', }) => {
        ...
        if (!(currentSelectionTextStyles === null || currentSelectionTextStyles === void 0 ? void 0 : currentSelectionTextStyles.includes(textStyle))) {
            setInputBlockInfoMap((currentInputBlockInfoMap) => (0, immutability_helper_1.default)(currentInputBlockInfoMap, {
                [currentInputBlockKey]: {
                    textStyleMap: {
                        $apply: function (currentTextStyleMap = {}) {
                            const textStyles = currentTextStyleMap[currentSelectionKey] || [];
                            //'|Hey|****' => '**Hey|**'
                            const mergingSelectionKey = (0, utils_1.getClosestSelectionKey)(currentTextStyleMap, currentSelectionKey, includeSelectionEnd);
                            if (mergingSelectionKey) {
                                const _a = currentTextStyleMap, _b = mergingSelectionKey, _ = _a[_b], //eslint-disable-line
                                filteredStyleMap = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
                                return Object.assign(Object.assign({}, filteredStyleMap), { [currentSelectionKey]: [...textStyles, textStyle] });
                            }
                            return Object.assign(Object.assign({}, currentTextStyleMap), { [currentSelectionKey]: [...textStyles, textStyle] });
                        },
                    },
                },
            }));
