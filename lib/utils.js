...
const getClosestSelectionKey = (textStyleMap, currentSelectionKey, inclusiveSelection = true) => {
    const { start: startIndex, end: endIndex } = (0, exports.getSelectionFromKey)(currentSelectionKey);
