...
// type InputBlockInfoSample = {
//   inputBlockInfo: InputBlockInfo;
//   styledLineMap: StyledLineMap;
// };

export type InputInfoStyledLineMap = { [key: LineKey]: StyledLineMap };
...
type TextSampleMap = { [key: string]: TextSample };

export const textSampleMap: TextSampleMap = {
  //title
  empty: {
    markdown: '',
    inputBlockInfoMap: {
