...
const platformModes: PlatformMode[] = ["ios", "android"];

platformModes.map((platformMode) => {
  describe(`useTextEditor platformMode: ${platformMode}`, () => {
    /*         //*/
    //init
    test("init", () => {
      const { result } = renderHook(() => useTextEditor({ platformMode }));
